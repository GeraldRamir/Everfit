            ...
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <a
                  ...
                  className="btn-everfit-orange inline-flex"
                >
                  {pages.planDetail.whatsappCta}
                </a>
                <Link
                  href={`/solicitud?servicio=plan-entrenamiento&plan=${encodeURIComponent(plan.slug)}`}
                  className="btn-everfit-ghost inline-flex"
                >
            ...
            <div className="lg:col-span-5">
              <div className="sticky top-28 rounded-2xl bg-everfit-cream p-6">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-everfit-primary mt-6 w-full"
                >
                  {pages.planDetail.whatsappCta} · {dict.site.whatsapp}
                </a>
                <Link
                  href={`/solicitud?servicio=plan-entrenamiento&plan=${encodeURIComponent(plan.slug)}`}
                  className="btn-everfit-outline mt-3 w-full"
                >
                  {pages.planDetail.signUp}
                </Link>
              </div>
